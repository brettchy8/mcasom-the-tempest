...
1. Open **Issues** and add the year, title, and PDF. Upload a file such as `2027.pdf`. Add an optional homepage photograph and its credit. The cover is generated automatically from the PDF.
2. Open **Authors** and add each contributor's name, biography, and optional portrait.
3. Open **Works**. Choose one issue and one author, enter the work, and add any artwork or MP3 recordings. Poetry preserves line breaks and indentation. A PDF page number adds a link into the reader; count the cover as page 1.
